    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon user white"></i><span class="break"></span>Ubah Data Guru</h2>
                <div class="box-icon">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <img src="assets/img/guru/<?php echo $hasil['foto']; ?>" style="width: 200px;float: left; margin-right: 10px;" />
                                <?php }else{?>
                                <img src="assets/img/noImg.png" style="width: 200px;" />
                                <?php }?>
                            </div>
                        </div>
